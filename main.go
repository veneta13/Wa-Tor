...
func init() {
	flag.IntVar(&WatorSim.InitFishCount, "fc", 500000, "Initial number of fish")
	flag.IntVar(&WatorSim.InitSharksCount, "sc", 50000, "Initial number of sharks")
	...
	flag.IntVar(&WatorSim.Height, "h", 4000, "Height of the board")
